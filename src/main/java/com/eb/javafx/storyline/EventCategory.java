 ...
 *
 * <ul>
 *   <li>{@link #LOCATION} — events bound to a location id (e.g. {@code rejuv-lab/recovery-room}).
 *       The tree's {@code categoryKey} is the location id at that level.</li>
 *   <li>{@link #CHARACTER} — events keyed by a character role id (e.g. {@code marsh}, {@code nurse}).
 *       Useful for relationship arcs.</li>
