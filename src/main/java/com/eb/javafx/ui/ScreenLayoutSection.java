...
public record ScreenLayoutSection(
    ...
    public ScreenLayoutSection {
        ...
        metadata = Map.copyOf(Validation.requireNonNull(metadata, "Screen layout section metadata is required."));
    ...
    public ScreenLayoutSection(String id, String title, List<String> lines, String styleClass, Map<String, String> metadata, List<String> lineIds) {
        this(id, title, lines, styleClass, metadata, lineIds, List.of());
    }

    public ScreenLayoutSection(String id, String title, List<String> lines, String styleClass, Map<String, String> metadata) {
        this(id, title, lines, styleClass, metadata, List.of());
    }

    public ScreenLayoutSection(String id, String title, List<String> lines, String styleClass, List<String> lineIds) {
        this(id, title, lines, styleClass, Map.of(), lineIds, List.of());
    }

    public ScreenLayoutSection(String id, String title, List<String> lines, String styleClass) {
        this(id, title, lines, styleClass, Map.of(), List.of());
    }

    public ScreenLayoutSection(String id, String title, List<String> lines) {
        this(id, title, lines, null, Map.of());
    }
}
