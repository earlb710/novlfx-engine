...
| `05-content-routing-and-scenes/SceneExecutionAndJsonDemo.java` | Loading scene JSON, pausing on text/choice steps, selecting a choice, and restoring state. | Prints the scene execution transcript and JSON round-trip length. |
...
| `07-display-support/DisplaySupportDemo.java` | Loading display definitions and resolving image display metadata. | Prints display definition IDs and image lookup details. |
...
| `09-game-support-state-save-prefs-random/CategoryCodeTableDefinitionDemo.java` | Loading localized category code table definitions. | Prints language, category, and code lookup information. |
