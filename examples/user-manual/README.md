...
| `../screen-designs/sample-screen-design.json` | Minimal form-style screen design JSON with one block and saved items. | Loaded by the screen designer or `ScreenDesignJson.load(...)`; it is not run directly. |
| `../screen-designs/main-menu-screen-design.json` | Menu/action-list screen design JSON showing button-style items. | Loaded by the screen designer or `ScreenDesignJson.load(...)`; it is not run directly. |
| `../screen-designs/quest-log-screen-design.json` | Multi-block screen design JSON for a richer content layout example. | Loaded by the screen designer or `ScreenDesignJson.load(...)`; it is not run directly. |
| `../screen-designs/gallery-preview-screen-design.json` | Preview/card-oriented screen design JSON example. | Loaded by the screen designer or `ScreenDesignJson.load(...)`; it is not run directly. |
